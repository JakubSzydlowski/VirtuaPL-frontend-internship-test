...
const sukcessMsg = document.querySelector(".sukcessMsg");
...
InputEmail.addEventListener("input", function() {
  const emailReq = /^([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x22([^\x0d\x22\x5c\x80-\xff]|\x5c[\x00-\x7f])*\x22))*\x40([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d)(\x2e([^\x00-\x20\x22\x28\x29\x2c\x2e\x3a-\x3c\x3e\x40\x5b-\x5d\x7f-\xff]+|\x5b([^\x0d\x5b-\x5d\x80-\xff]|\x5c[\x00-\x7f])*\x5d))*(\.\w{2,})+$/;
...
checkbox.addEventListener("input", function() {
  ...
  console.log(FLAGcheckbox);
});

const submitAndEnd = function() {
  popup.style.display = "none";
  btnClickMe.style.display = "none";
  sukcessMsg.classList.add("MsgActive");
};
...
const submit = function() {
  if (FLAGemail === false && FLAGpassword === false && FLAGcheckbox === false) {
    ...
    alert(
      "Enter the email and password correctly and confirm the agreement to term & conditions."
    );
  }
};
